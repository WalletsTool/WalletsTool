...
// 表格列定义
const columns = [
  { title: "序号", width: 53, slotName: "index" },
  { title: "发送方私钥", width: 160,dataIndex: "private_key", ellipsis: true, tooltip: true },
  { title: "接收地址", width: 260, dataIndex: "to_addr", ellipsis: true, tooltip: true },
  ...
  { title: "状态", slotName: "exec_status", ellipsis: true, tooltip: true },
