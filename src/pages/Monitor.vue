...
// 总余额
let totalBalance = ref(1245.214)
// 监控时长
let monitorTimeStr = ref('00:30:15')
// 报警次数
...
<template>
    <div class="container monitor">
        <span class="pageTitle">链上余额监控</span>
        <!-- 工具栏 -->
        <div class="toolBar">
            ...
            <div style="display: flex">
                ...
                <a-form ref="formRef" :model="form" layout="vertical">
                    <a-row style="height: 100px">
                        ...
                        <a-form-item field="interval" label="每轮查询间隔时间（秒）" style="width: 240px;padding: 10px"
                                     tooltip="范围在（0-600）秒之间">
                            <a-input-number :max="600" :min="0" v-model="form.interval"/>
                        </a-form-item>
                    </a-row>
                </a-form>
